...
def my_custom_gradient(parameter, scale, penalty_rate):
    ...
    print("TESTING SHAPES OF PARAMETER", parameter.shape)
    print("TESTING SHAPES OF SCALE", scale.shape)
    ...
    def custom_grad(dy, variables=None):
        if len(parameter.shape) == 1:
            ...
            print("TESTING SHAPES OF MAXVALUE", scale.shape)
        ...
        print("TESTING PARAMETER GRADS", dy.shape)
        print("TESTING SCALE GRADS", scale_grads.shape)
